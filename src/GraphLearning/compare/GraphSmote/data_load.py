...
def load_data(path="data/plbart/", dataset="cora"):#modified from code: pygcn
    ...
    classes_dict = {'0': 0, '1': 1} #, 'Probabilistic_Methods': 2, 'Case_Based': 3, 'Theory': 4, 'Rule_Learning': 5, 'Genetic_Algorithms': 6}
